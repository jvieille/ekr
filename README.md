...
A contribution does **not** acquire EKR authority merely by being posted, discussed, accepted for investigation or merged into a draft.
...
- **Submit** structured proposals, counterexamples, implementation experience or references/evidence through [Issues](https://github.com/jvieille/ekr/issues).
...
The Working Definition V0.1 is published. The repository is now establishing the public development process and the seed for **EKR Architectural Guidance V0.1**. The near-term sequence is described in [ROADMAP.md](ROADMAP.md).
